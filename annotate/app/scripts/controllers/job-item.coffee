...
class JobItemCtrl extends Ctrl
  ...
  changeTab: (type)=>
    @scope.$emit "changeMode", type
    @state.go "job.item.#{type}", jobId:@state.params.jobId
...
angular.module('simpleannotateApp').controller('JobItemCtrl', JobItemCtrl)
